...
class BookingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_empresas_documento_quarto_idx' => ['type' => 'index', 'columns' => ['reserva_numero'], 'length' => []],
            'fk_documento_status' => ['type' => 'index', 'columns' => ['status'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['reserva_numero'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
